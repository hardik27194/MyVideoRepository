...
- (void)borderChooseAction:(id)sender
{
    ...
    if (self.borderType == VideoBorderType1) {
        ...
        [_delegate videoFitToolbar:self reviewAtFitType:self.fitType andBorderType:VideoBorderType2];
    }else if (self.borderType == VideoBorderType2){
        [self setBorderType:VideoBorderType3];
        [_delegate videoFitToolbar:self reviewAtFitType:self.fitType andBorderType:VideoBorderType3];
    }else if (self.borderType == VideoBorderType3){
        [self setBorderType:VideoBorderTypeOriginal];
        [_delegate videoFitToolbar:self reviewAtFitType:self.fitType andBorderType:VideoBorderTypeOriginal];
    }else{
        [self setBorderType:VideoBorderType1];
        [_delegate videoFitToolbar:self reviewAtFitType:self.fitType andBorderType:VideoBorderType1];
    }
}
...
- (void)buttonAction:(id)sender
{
    ...
    [_delegate videoFitToolbar:self reviewAtFitType:self.fitType andBorderType:self.borderType];
}
